...
date = "2021-03-17T16:01:00Z"

[extra]
original = "https://uwcs.co.uk/news/week-10-term-2-newsletter/"    
categories = ["Newsletter"]
+++

<p>Week 10 Term 2 Newsletter</p>

<!-- more -->

Hello Everyone\!

Week 10\! The end\! This is my final newsletter as Secretary, the next one will be taken over by our new Secretary Josh\!

## Lightning Talks - Thursday 18th 8pm

**Tomorrow evening (Thursday) at 8pm** we'll be having our last set of lightning talks before the Easter holidays\! This time we'll be avoiding the interesting piece of software that is Teams and doing it directly in our Discord VCs\! Anyone is free to come along and learn about the various topics we'll have talks on.

The titles and topics of them are as follows:

  - **How to get started with shaders** - by Daniel Ilett (current President of the Warwick Game Design Society)
  - **How do you Vue? - A brief introduction to Vue.js** by Sleepless
  - **Web Development Karaoke Talk** - given by finnbar, written by Sleepless

## Mascot/Flag/Motto Referendum Results

Recently we ran a referendum on a society Flag + Mascot + Motto thanks to the motions put forth in the AGM, the results of the referendum are in. CompSoc, I present to you: Our Flag\! Our Mascot\! Our Motto\!

**Flag**: Modernity

**Mascot**: The colour Incremental Blue (\#123456)

**Motto**: Computatrum dormiens nunquam tittilandus
