+++
title = "Week 1 Term 2 Newsletter"
date = "2021-01-11T15:21:00Z"

[extra]
original = "https://uwcs.co.uk/news/week-1-term-2-newsletter/"    
categories = ["Newsletter"]
+++

<p>Week 1 Term 2 Newsletter</p>

<!-- more -->

Hello Everyone\!

Welcome to term 2. I hope everyone had a lovely Christmas and New Year. We look forward to seeing you all again.
...
If you are interested and would like more information, check out our <span id="2333">Exec</span> page for more on what each exec position is responsible for.

## (W)LAN - Week 3

Mark it in your calendars, prepare yourself. For we shall be running another Remote LAN in Week 3. We'll be putting out a poll for name suggestions and will have fun events lined up.

## Friday Gaming

Term has started again and that means gaming is officially back on\! You may have noticed it lived on during the holiday, but now it's actually official again. We will be playing video games, probably some Jackbox. Maybe even TTT.

## Film Night - Sunday 17th

We'll be watching *We Can Be Heroes* on **Sunday Week 1 (Jan 17th) at 7pm**.

We'll be using one of our voice channels and syncing the movie on Netflix with Teleparty (<https://www.netflixparty.com/>); although if you have your own source then feel free to sync that with us manually.
