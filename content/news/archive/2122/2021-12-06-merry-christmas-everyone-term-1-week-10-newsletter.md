...
Hello everyone\! We've made it to week 10, and there's a nice break from work on the horizon - but for now, here's this weeks newsletter\!

### **EGM Results**

As many of you will have seen, we recently held an Extraordinary General Meeting to elect a new Gaming Coordinator, and also propose some constitution-changing motions. Unfortunately, the votes on both constitution-changing motions were inquorate, and so they cannot be put into action, however, the results are included below, in the format For/Against (Abstentions):

**Motion to Require the Appointment of a Standing President in the Event of Extended Absence or Resignation of the President:**

Passed 17/4 (1)

**Motion to Include the Society’s Affiliation with the British Computing Society within the Constitution:**

Passed 20/1 (1)

The election of a new Gaming Coordinator was won by Felix Bowyer, but this was also unfortunately inquorate, and so the position remains unfilled for now.

### **DCS Christmas Party Gaming\!**

#### *\[Week 10\] Wednesday 8th, 2pm-Late Afternoon, Department of Computer Science*

The Department of Computer Science will be holding their very own Christmas party this Wednesday, but make sure to stick around as throughout the afternoon, we'll be having some fun on the ground floor of DCS too\! Our consoles will be in action, and Steam will be available on some of the PCs for you to play your own library of games too\!

( *Reminder: We will be following the Covid-19 guidelines provided by DCS at the event, which are to wear a mask if you wish, although there is no obligation to do so* )

For further information about the event, see here: <https://warwick.ac.uk/fac/sci/dcs/teaching/dcsnoticeboard/xmas2021social/>

### 🎮 **Friday Night Gaming - Now with VR\!**

#### *\[Week 10\] Friday 10th, 7pm-12am, Department of Computer Science*
...
Following the Christmas break, we already have some events planned for you all, alongside our usual Pub social and Friday Night Gaming\! If you're here for the academic side of things, we'll be holding our next set of Lightning talks, or if you prefer the gaming side of the society, we have two LANs planned in Weeks 2 and 7 - keep your eyes peeled for more information on these, coming soon\!

### **This Week in UWCS\!**

Here's our schedule for the final few days of term\!

Have a lovely week, and enjoy your holidays\!
