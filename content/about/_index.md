...
You can see the known history of elected exec [here](@/exec/history.md), our democracy repo with history of recent motions and results [here](https://github.com/UWCS/democracy) and our current constitution [here](https://github.com/uwcs/democracy/releases/latest/download/constitution.pdf).